...
{
    public static Toast m_CarNumExt2;
    ...
    private static EditText m_CarNumExt = null;
    private SurfaceView m_osurfaceView = null;    
    private final static int REQUEST_CODE = 1;
    private static final int UPDATE_NUMBER = 0x001;
    private static final int UPDATE_NUMBER2 = 0x002;
    ...
    public   HCNetSDKByJNA.NET_DVR_PLATE_RESULT plate_result;
    private ImageView m_CarNum=null;
    private JNATest.FMSGCallBack  fmsgCallBack=null;

//    public class SearchThread extends Thread{
//        @Override
//        public void run()
//        {
//            Message m=handler.obtainMessage(); //通过Handler 获取一个消息对象
//            if (JNATest.CarNum!=null) {
//                m.arg1 = Integer.parseInt(JNATest.CarNum);
//                Log.e("cardNo", JNATest.CarNum);
//                m.what = UPDATE_NUMBER;
//            }
//            //JNATest.TEST_Config(m_iPlayID, m_iLogID, m_iStartChan);
//
//           // fmsgCallBack=new JNATest.FMSGCallBack();
//
//           // JNATest.Test_Alarm(m_iLogID);
//        //    m_CarNumExt.setText(JNATest.CarNum);
...
//        }
        ...
        initeSdk();
        initeActivity();
        m_oIPAddr.setText("115.4.29.204");
        m_oPort.setText("8000");
        m_oUser.setText("admin");
        m_oPsd.setText("Admin12345");

        mHandler = new Handler();
        mHandler.post(runnable);


       new Thread(new MyThread1()).start(); //子线程1启动
    }
//    //消息处理器1 ，创建Handler的子类对象，目的是重写Handler的方法
    private Handler handler=new Handler(){
       @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg); //UI线程消息处理控制
           switch (msg.what)
           {
                case UPDATE_NUMBER:
                   m_CarNumExt.setText(String.valueOf(msg.arg1));
           }
        }
    };
    ...
    /*
     *
     * 子线程：在子线程不能访问UI线程的UI组件（工具包）,除非是进度条极小数的情况
     * */
    ...
    class MyThread1 implements  Runnable{
        ...
        public void run() {
         ...
         //   m_CarNumExt.setText(String.valueOf(Math.random()*100));
            mHandler.postDelayed(this, 100);                             //相当于定时器，每隔0.1s执行一次该线程
            m_CarNumExt.setText(String.valueOf(JNATest.CarNum));                      //车牌号输出到EditText
            //gbk转utf-8
...
//            params.bottomMargin = 0;
    ...
    private void findViews() 
    {
        ...
        m_CarNum=(ImageView) findViewById(R.id.img_CarNum);
        m_CarNumExt=(EditText) findViewById(R.id.EDT_CarNum);
    }
    ...
    private Button.OnClickListener OtherFunc_Listener = new OnClickListener()
    {
        public void onClick(View v)
        {
           ...
           // Toast.makeText(DemoActivity.this, String.valueOf(b), Toast.LENGTH_LONG).show();

             // int b=plate_result.byPicNum;

            // int b= plate_result.pBuffer3.getValue();
           // String b="saj;fajlkjfa";

           // m_CarNum.setImageBitmap();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {  
        	...
        	{										//inner class - new thread to get device list
        		@Override
        		public void run()
        		{
                    Demo.get_device_ip();
